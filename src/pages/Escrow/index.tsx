                    ...
                    <Grid item xs={6}>
                        <Box sx={{ 
                            height: '182px',
                                    ...
                                    <EscrowedCard unlockCard title="AVAILABLE HZN" color={COLOR.safe} amount={32321432.53}/>
                        ...
                        <Grid container spacing={'10px'}>
                            <Grid item xs={12}>
                                <Box sx={{ 
                                    ...
                                    <EscrowedCard title="Total ESCROWED" color={COLOR.safe} amount={34321432.53}/>
                                </Box>
                            </Grid>
                            <Grid item xs={12}>
                                <Box sx={{ 
                                    height: '86px' ,
                                        ...
                                        <EscrowedCard title="TOTAL UNLOCKED" color={COLOR.text} amount={545445.53}/>
                                </Box>
                            </Grid>
                        </Grid>
                    </Grid>
